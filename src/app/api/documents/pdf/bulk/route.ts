        ...
        <body>
            ...
            <div class="doc-page">
                <div class="doc-container">
                    <!-- Header space - blank per request -->
...
export async function POST(request: NextRequest) {
    try {
        ...
        const settings = {
            ...
            signatureImageUrl: signatureImageUrl ?? dbSettings.signature?.signatureImageUrl ?? '/images/Sig_Seal.png',
        };

        // Generate HTML for each job using the exact same function as single document generation
        const documentsHtml = jobs.map((job) => {
        ...
        return new NextResponse(documentsHtml, {
            headers: {
